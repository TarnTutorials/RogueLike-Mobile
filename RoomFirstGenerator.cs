...
public class RoomFirstGenerator : MapGenerator
{
   ...
   {
    var roomsList = GenerationAlgorithm.BSPAlgorithm(new BoundsInt((Vector3Int)startPos, new Vector3Int(dungeonWidth, dungeonHeight, 0)), minRoomWidth, minRoomHeight);
   ...
   private HashSet<Vector2Int> CreateRandomRooms(List<BoundsInt> roomsList)
   {
        ...
        for (int i = 0; i < roomsList.Count; i++)
        {
            ...
            var roomFloor = RandomWalk(roomCenter, iterations, walkLength, startRandomly);
